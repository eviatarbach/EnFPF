...
dists = [Metrics.wasserstein(analyses_unfiltered[i, :, :], invariant, ens_size, 1500) for i=1:300]
dists_da = [Metrics.wasserstein(analyses_filtered[i, :, :], invariant, ens_size, 1500) for i=1:300]